...
describe Smithy::ContentBlocks::Registry do
  before do
    Smithy::ContentBlocks::Registry.clear
  ...
  it "won't add a content block to the DB that already exists" do
  ...
  it "adds a content block to the DB" do
    expect { Smithy::ContentBlocks::Registry.register("Bar") }.to change{Smithy::ContentBlock.count}.by(1)
  end
end
