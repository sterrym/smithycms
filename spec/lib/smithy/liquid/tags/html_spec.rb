...
describe Smithy::Liquid::Tags::Html do
  it 'renders the stylesheet link tag' do
    ...
    html.should eql '<link href="/assets/application.css" media="screen" rel="stylesheet" />'
  end

  it 'renders the javascript include tag' do
    html = render_tag('javascript_include_tag', 'application')
    html.should eql '<script src="/assets/application.js"></script>'
  end

  it 'renders the smithy javascript include tag' do
    html = render_tag('smithy_javascript_include_tag', 'application')
    html.should eql '<script src="/templates/javascripts/application.js"></script>'
  end
  ...
  it 'renders the smithy stylesheet link tag' do
    ...
    html.should eql '<link href="/templates/stylesheets/application.css" media="screen" rel="stylesheet" />'
  end
