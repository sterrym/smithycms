...
describe Smithy::Liquid::Tags::Html do
  ...
  it 'renders the javascript include tag' do
    ...
    html.should eql '<script src="/assets/foo.js"></script>'
  end

  it 'renders the smithy javascript include tag' do
    html = render_tag('smithy_javascript_include_tag', 'foo')
    html.should eql '<script src="/templates/javascripts/foo.js"></script>'
  end
  ...
  it 'renders the smithy stylesheet link tag' do
    ...
    html.should eql '<link href="/templates/stylesheets/foo.css" media="screen" rel="stylesheet" />'
  end
