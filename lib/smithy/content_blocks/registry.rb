    ...
    class Registry
      ...
      class << self
        ...
        def register(content_block, description = nil)
          return unless ActiveRecord::Base.connection.table_exists?(Smithy::ContentBlock.table_name) && ActiveRecord::Base.connection.table_exists?(content_block.table_name)
